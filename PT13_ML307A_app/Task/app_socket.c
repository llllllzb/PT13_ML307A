...
{
    tmos_memset(socketList, 0, sizeof(socketList));
    tmos_memset(&sockSchInfo, 0, sizeof(SocketScheduleInfo_s));
}
    ...
    switch (sockSchInfo.runFsm)
    {
        ...
        case SOCKET_SCHEDULE_CONN:
            ...
            else if (sockSchInfo.runTick > 60)
            {
				...
				if (socketList[sockSchInfo.ind].socketId == NORMAL_LINK || socketList[sockSchInfo.ind].socketId == JT808_LINK)
				{
